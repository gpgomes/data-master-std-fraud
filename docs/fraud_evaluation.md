...
- **Viagens legítimas.** Cerca de 1% dos clientes já começa o replay viajando (estado estacionário). Quem viaja fica em trânsito, sem emitir eventos, durante o deslocamento, e transaciona na cidade destino por 6 a 48 h; a fração de eventos `travel` fica por isso abaixo de 1%.
